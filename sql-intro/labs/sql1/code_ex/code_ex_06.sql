...
--Uncomment code below to run the code for slide 09_na for lesson 6
...
--Uncomment code below to run the code for slide 10_sb for lesson 6
...
--Uncomment code below to run the code for slide 12_sa for lesson 6
...
--Uncomment code below to run the code for slide 12_sb for lesson 6
...
--Uncomment code below to run the code for slide 18_na for lesson 6
...
--Uncomment code below to run the code for slide 20_sb for lesson 6
...
--Uncomment code below to run the code for slide 20_nb for lesson 6
...
--Uncomment code below to run the code for slide 21_na for lesson 6
...
--Uncomment code below to run the code for slide 24_na for lesson 6
/*
                 SELECT   department_id, AVG(salary)
                 FROM     employees
                 GROUP BY department_id
