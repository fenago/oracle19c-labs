...
--Uncomment code below to run the code for slide 19_sa for lesson 5
/*
...
--Uncomment code below to run the code for slide 21_nb for lesson 5
...
--Uncomment code below to run the code for slide 22_sa for lesson 
...
--Uncomment code below to run the code for slide 22_na for lesson 5
/*
                      SELECT last_name, TO_CHAR(hire_date, 'DD-Mon-yyyy')
                      FROM   employees
                      WHERE  TO_DATE(hire_date, 'DD-Mon-yy') < '01-Jan-10';
...
--Uncomment code below to run the code for slide 26_na for lesson 5
...
--Uncomment code below to run the code for slide 30_sa for lesson 5
...
--Uncomment code below to run the code for slide 35_sa for lesson 5
...
--Uncomment code below to run the code for slide 38_sa for lesson 5
