...
mkdir /u02/app/oracle/oradata/CDB19/pdb19
$ORACLE_HOME/bin/sqlplus "/ as sysdba" @$HOME/labs/SEC/startup.sql
$ORACLE_HOME/bin/sqlplus "/ as sysdba" @$HOME/labs/SEC/create_PDB19.sql
$ORACLE_HOME/bin/sqlplus "/ as sysdba" @$HOME/labs/SEC/drop_create_user_sec_admin.sql
$ORACLE_HOME/bin/sqlplus "c##sec_admin/Welcome_1@CDB19" @$HOME/labs/SEC/enable_DV.sql
$ORACLE_HOME/bin/sqlplus "/ as sysdba" @$HOME/labs/SEC/shutdown.sql
$ORACLE_HOME/bin/sqlplus "/ as sysdba" @$HOME/labs/SEC/startup.sql
$ORACLE_HOME/bin/sqlplus "sys/Welcome_1@PDB19 AS SYSDBA" @$HOME/labs/SEC/configure_DV_in_PDB.sql
$ORACLE_HOME/bin/sqlplus "/ as sysdba" @$HOME/labs/SEC/shutdown.sql
$ORACLE_HOME/bin/sqlplus "/ as sysdba" @$HOME/labs/SEC/startup.sql
$ORACLE_HOME/bin/sqlplus "c##sec_admin/Welcome_1@PDB19" @$HOME/labs/SEC/enable_DV_in_PDB.sql
$ORACLE_HOME/bin/sqlplus "/ as sysdba" @$HOME/labs/SEC/shutdown.sql
$ORACLE_HOME/bin/sqlplus "/ as sysdba" @$HOME/labs/SEC/startup.sql