...
--Uncomment code below to run the code for slide 08_sa for lesson 3
...
--Uncomment code below to run the code for slide 08_sb for lesson 3
...
--Uncomment code below to run the code for slide 08_na for lesson 3
...
--Uncomment code below to run the code for slide 10_sb for lesson 3
...
--Uncomment code below to run the code for slide 13_na for lesson 3
...
--Uncomment code below to run the code for slide 15_na for lesson 3
...
--Uncomment code below to run the code for slide 19_sa for lesson 3
...
--Uncomment code below to run the code for slide 26_sb for lesson 3
...
--Uncomment code below to run the code for slide 30_sa for lesson 3
...
--Uncomment code below to run the code for slide 30_sb for lesson 3
...
--Uncomment code below to run the code for slide 38_sa for lesson 3
/*
...
--Uncomment code below to run the code for slide 42_sa for lesson 3
