...
END;
/
SELECT * FROM employees2 WHERE department_id = 10;
*/
...
-- (employees2 table is created using the code under slide 17_sa.sql of code_ex_05.sql)

SET SERVEROUTPUT ON

DECLARE
v_rows_deleted VARCHAR2(30);
v_empno employees2.employee_id%TYPE := 165;
BEGIN
DELETE FROM employees2
